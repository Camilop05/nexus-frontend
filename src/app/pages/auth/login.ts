  ...
  template: `
    ...
    <div class="nx-screen">
      <div class="nx-panel">
        ...
        <h1 class="nx-heading">Verificación de acceso</h1>
        <p class="nx-sub">Ingresa tus credenciales para continuar.</p>
        ...
        <div class="nx-foot">¿No tienes acceso? <a routerLink="/auth/register">Solicítalo aquí</a></div>
      </div>
    </div>
